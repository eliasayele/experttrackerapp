...
class ChatUiCustomer extends StatelessWidget {
...
final List<Friend> friends = [
  ...
  Friend('Alem', avatars[1], 'Hello, how are you?', '1 hr.'),
  Friend('Bini', avatars[2], 'Hello, how are you?', '1 hr.'),
  Friend('Esa', avatars[3], 'Hello, how are you?', '1 hr.'),
  Friend('Rebqa', avatars[4], 'Hello, how are you?', '1 hr.'),
